...
void Pid::runYawOptimizer(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
...
void Pid::saveYawError(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
  yaw_previous_error = yawError(gyro_yaw, yaw_desired_angle, yaw_compass_mode);
}

void Pid::printPid(float gyro_roll, float roll_desired_angle, float gyro_pitch, float pitch_desired_angle, float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
...
float Pid::pitchError(float gyro_pitch, float pitch_desired_angle)
{
  return pitch_desired_angle - gyro_pitch;
}

float Pid::pitchPidP(float gyro_pitch, float pitch_desired_angle)
{
  return pid_pitch_optimizer.getKp() * pitchError(gyro_pitch, pitch_desired_angle);
}

float Pid::pitchPidD(float gyro_pitch, float pitch_desired_angle)
{
  return pid_pitch_optimizer.getKd() * (pitchError(gyro_pitch, pitch_desired_angle) - pitch_previous_error);
}

float Pid::yawPid(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
...
float Pid::yawError(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
  if (yaw_compass_mode)
  {
...
float Pid::yawPidP(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
...
float Pid::yawPidD(float gyro_yaw, float yaw_desired_angle, bool yaw_compass_mode)
{
